...
if __name__ == "__main__":
    ...
    cont = False
    if SELECT_DATA=="dblp":
        args.train_data_path = '../../data/TopoGramFiles/dblp_oneorder_data/sample_train.tsv'
        args.valid_data_path='../../data/TopoGramFiles/dblp_oneorder_data/valid.tsv'
        # args.test_data_path='../../data/TopoGramFiles/dblp_oneorder_data/test.tsv'
        # args.test_data_path='../../data/TopoGramFiles/dblp_twoorder_neighbors/test_5.tsv'
        args.test_data_path='../../data/TopoGramFiles/dblp_twoorder_neighbors/test_popularity.tsv'
        args.block_size = 32
        ...
        args.test_data_path='../../data/TopoGramFiles/wikidata5m_oneorder_neighbors/test_popularity.tsv'
        args.block_size = 64
    ...
    if 'train' in args.mode:
        ...
        if args.world_size > 1:
            ...
            train(0,args,prefetch_step,end,True)


    if 'test' in args.mode:
        print('-------------test--------------')
        args.load_ckpt_name="../../checkpoint/onetower-{}-best.pt".format(SELECT_DATA)
        if args.world_size > 1:
            mp.freeze_support()
            mgr = mp.Manager()
            end = mgr.Value('b', False)
